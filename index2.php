...
<html lang="en">
    ...
    <link rel="stylesheet" href="stylesheet.css" type="text/css">
        ...
        <script data-ad-client="ca-pub-6520643463095044" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
  ...
  <nav>
    <ul>
      ...
      <li><a href="#" class="langList">Portuguese</a></li>
      ...
      <li><a href="https://kaigaitripzuki.hateblo.jp/" class="langList">BLOG(friend's)</a></li>
       ...
       <main>
            ...
            <div class="main-content">
                ...
                <form action="./result.php" method="POST" class="search_container" class="form" > 
