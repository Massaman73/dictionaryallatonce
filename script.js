        ...
        $(function(){
           jQuery("#Switch").on("click",function(){
            ...
            jQuery("#Switch2").on("click",function(){
              ...
              jQuery("#Input").attr("placeholder","buscar...")
            ...
            let reference = document.getElementsByTagName(sx);
            let parent = document.getElementsByClassName('verbete');
            let BR = parent.insertBefore(newEle, reference);
            console.log(BR);
